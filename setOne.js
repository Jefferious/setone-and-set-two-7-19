...
// CODE HERE
let giveParameter = (parameter1, parameter2) => `The first parameter is ${parameter1}. The second parameter is ${parameter2}.`


// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.
console.log(giveParameter('hello', 89))
...
let greeting = (firstName, lastName, callback) =>{
    // let operation = `Hello, my full name is ${firstName} ${lastName}`
    callback(firstName + lastName)
}

// INVOKE 'GREETING FUNCTION' HERE
greeting('Jeffery', 'Whittington', (fullName)=> console.log(`Hello, my full name is ${fullName}`))
...
let multiplyingFactory = (num1) => {
    return (num2) => {
        ...
        } else console.log('Cannont multiply: the first number is smaller than 5.')
    }
}
